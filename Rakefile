...
Rake::RDocTask.new(:rdoc) do |rdoc|
  ...
  rdoc.rdoc_files.include('doc/**/*.rdoc', 'lib/**/*.rb', 'app/*/porter/**/*.rb')
...
spec = Gem::Specification.new do |s|
  s.name = "porter"
  s.summary = %Q{Porter is a Rails auth system}
  s.description = %Q{A Porter is doing fare control. So Porter is an authentication system for Rails 3 applications.}
  s.email = 'info@spom.net'
  s.homepage = 'http://spom.net/'
  s.authors = ['Sven G. Broenstrup']
  s.files = Dir["{lib}/**/*", "{app}/*/porter/**/*", "{config}/routes.rb", "{config}/locales/*", "{db}/migrate/*", "{compass}/**/*", "VERSION", "README*", "LICENCE", "Gemfile"]
...
#  s.add_development_dependency 'markup_validity', '>= 1.1.0'
  ...
  s.add_dependency 'humpyard_form', '>= 0.0.1'
end
